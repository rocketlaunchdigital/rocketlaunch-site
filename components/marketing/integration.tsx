        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20 scale-">
            <Container className="relative">
                <div className="relative flex flex-col lg:hidden items-center justify-center overflow-visible">
                    <div className="absolute top-1/2 -translate-y-1/2 right-1/4 w-3/5 h-14 lg:h-20 bg-gradient-to-r from-[#B366FF] to-[#8F00FF] rounded-full -rotate-12 blur-[6.5rem] -z-10"></div>
            ...
            <Container delay={0.3}>
                <div className="relative hidden lg:flex items-center justify-center overflow-visible">
                    ...
                    <div className="absolute z-20 flex items-center justify-center group">
                        <div className="size-24 rounded-full bg-gradient-to-b from-[#B366FF] to-[#8F00FF] flex items-center justify-center shadow-xl shadow-[#8F00FF]/20 group-hover:scale-110 transition-all duration-500">
